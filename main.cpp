 ...
 * Created on October 18, 2015, 5:00 PM
 * Purpose: Battleship version 
 */
...
void clear(int **);   //The clear function zeros the game board 
void show (int **);  //The show function will show the final results at end
int NumShip(int**);  //The function will determine how many ships there is 
void shipset(int, int **);  //The function will set the ships in the board/array as 1's
bool attack(int,int, int **);  //Function has user input coordinates 
...
{
    Yo b;  //Passing structure from header file.
    Hey a;  //Passing structure from header file.
...
{
    Yo a; //Passing structure from header file.
...
PLASHIP UISP()
{
    Yo c;//Passing structure from header file.
...
{
    Yo e; //Passing structure from header file.
    Hey d; //Passing structure from header file.
...
void shipset(int maxShip, int ** ma){
    int s = 0;
    while(s < maxShip){
        int x = rand() % 4;
        int y = rand() % 4;
...
bool attack( int x,int y, int **mat){
